...
function ResetPassword(props) {
    ...
    if (form === 1) {
        ...
        formActive = (
            <FormCodeVerif
                ...
                id='verif-code'
                ph='0'
                label='Verifivation Code'
            />
        );
        txtResend = (
            <p className='txtresend'>
                Didn’t receive a code?<Link to='/reset-password'>Resend</Link>
            </p>
        );
        ...
        pwLengthMsg = (
            <small className='lenPwTxt password d-flex justify-content-start'>
        ...
        matchMsg = match ? (
            <small className='match password d-flex justify-content-start'>
                Password match <img src={matchIcon} alt='match icon' />
            </small>
        ) : match === undefined ? (
    ...
    return (
        <>
            <div
                className='container-fluid reset-pass'
                style={{ padding: '0' }}
            >
                <div className='row text-center'>
                    ...
                    <div className='col-6 left-panel container-fluid'>
                        ...
                        <img
                            src={props.ava}
                            className='img-fluid image-reset'
                            alt='avatar '
                        />
                    </div>
                    ...
                    <main className='col-6 right-panel flex-column container-fluid'>
                        ...
                        <form onSubmit={submitHandler} className='reset-form'>
                            ...
                            <button
                                type='submit'
                                className='btn btn-send btn-verify'
                            >
                                {props.btnName}
                            </button>
                        </form>
                        ...
                        <div className={pwModalClass.join(' ')}>
                            ...
                            <img
                                className='changedIcon'
                                src={changedIcon}
                                alt='changed Icon'
                            />
                            <Link className='txtLoginBack' to='/'>
