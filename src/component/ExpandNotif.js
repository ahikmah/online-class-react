...
function ExpandNotif(props) {
  return (
        <>
        <div className={props.flg ? "overlay-notif" : "hidden"} onClick={props.clc}>
                <main className="all-notif">
            <Link to="?" onClick={props.clc} className="close-btn-notif">
            ...
            <section className="today-group-notif">
                ...
                <div className="col-2 list-notif-time">2 min</div>
                </div>
                ...
                <div className="col-2 list-notif-time">1 hr</div>
                </div>
                ...
                <div className="col-2 list-notif-time">2 hr</div>
                </div>
                ...
                <div className="col-2 list-notif-time">10 hr</div>
                </div>
                ...
                <div className="col-2 list-notif-time">15 hr</div>
                </div>
            </section>
            ...
            <section className="today-group-notif">
                ...
                <div className="col-2 list-notif-time">Yesterday</div>
                </div>
            ...
            <section className="today-group-notif">
                ...
                <div className="col-2 list-notif-time">8/10</div>
                </div>
                <div className="list-notif d-flex justify-content-between align-items-center">
                <div className="col-1 list-notif-icon">
